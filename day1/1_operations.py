...
# Operators are the mathematical and logical symbols to perform operations in a programming language
...
b = 2
print(a + b)  # print() is a python built-in function to view the results in a console  # 3
